...
Refer to [UPGRADING_DEPENDENCIES.md](https://gitlab.com/digitalizm/grafana/blob/master/UPGRADING_DEPENDENCIES.md).
...
We want to migrate away from this by using the `inject` package to wire up all dependencies either in `pkg/cmd/grafana-server/main.go` or self-registering using `registry.RegisterService` ex https://gitlab.com/digitalizm/grafana/blob/master/pkg/services/cleanup/cleanup.go#L25.
...
The plan is to move all settings to from package level vars in settings package to the [setting.Cfg](https://gitlab.com/digitalizm/grafana/blob/df917663e6f358a076ed3daa9b199412e95c11f4/pkg/setting/setting.go#L210) struct. To access the settings, services and components can inject this setting.Cfg struct:

[Cfg struct](https://gitlab.com/digitalizm/grafana/blob/df917663e6f358a076ed3daa9b199412e95c11f4/pkg/setting/setting.go#L210)
[Injection example](https://gitlab.com/digitalizm/grafana/blob/df917663e6f358a076ed3daa9b199412e95c11f4/pkg/services/cleanup/cleanup.go#L20)
...
- [Data sources](https://gitlab.com/digitalizm/grafana/tree/master/pkg/services/provisioning/datasources)
- [Alert notifiers](https://gitlab.com/digitalizm/grafana/tree/master/pkg/services/provisioning/notifiers)
- [Dashboards](https://gitlab.com/digitalizm/grafana/tree/master/pkg/services/provisioning/dashboards)
