...
With the design system @grafana/ui, we want to democratize development. This library of reusable [Grafana](https://github.com/Fenrislol/grafana) components and guidelines helps you with contribution and plugin development.
...
- **Use them**
  ...
  For more details, refer to the [package source](https://github.com/Fenrislol/grafana/tree/master/packages/grafana-ui).
