...
With the design system @grafana/ui, we want to democratize development. This library of reusable [Grafana](https://gitlab.com/digitalizm/grafana) components and guidelines helps you with contribution and plugin development.
...
- **Use them**
  ...
  For more details, refer to the [package source](https://gitlab.com/digitalizm/grafana/tree/master/packages/grafana-ui).
