...
See [Grafana packages versioning guide](https://github.com/Fenrislol/grafana/blob/master/packages/README.md#versioning).
...
To learn more about using Grafana theme please refer to [Theme usage guide](https://github.com/Fenrislol/grafana/blob/master/style_guides/themes.md#react)
...
grafana-toolkit comes with [default config for ESLint](https://github.com/Fenrislol/grafana/blob/master/packages/grafana-toolkit/src/config/eslint.plugin.json). For now, there is now way to customise ESLint config.
...
1. Clone [Grafana repository](https://github.com/Fenrislol/grafana).
