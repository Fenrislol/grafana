...
1. Open a terminal and run `git clone https://gitlab.com/digitalizm/grafana.git`. This command downloads Grafana to a new `grafana` directory in your current directory.
