...
New versions of Grafana can sometimes cause plugins to break. Checkout our [PLUGIN_DEV.md](https://gitlab.com/digitalizm/grafana/blob/master/PLUGIN_DEV.md) doc for changes in
...
We currently have three different examples that you can fork/download to get started developing your grafana plugin.
 ...
 - [clock-panel](https://github.com/grafana/clock-panel)
 - [singlestat-panel](https://gitlab.com/digitalizm/grafana/blob/master/public/app/plugins/panel/singlestat/module.ts)
