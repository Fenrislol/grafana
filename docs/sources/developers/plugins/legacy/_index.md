...
1. [Set up Grafana](https://gitlab.com/digitalizm/grafana/blob/master/contribute/developer-guide.md)
...
New versions of Grafana can sometimes cause plugins to break. Check out our [PLUGIN_DEV.md](https://gitlab.com/digitalizm/grafana/blob/master/PLUGIN_DEV.md) doc for changes in
...
- [SDK file in Grafana](https://gitlab.com/digitalizm/grafana/blob/master/public/app/plugins/sdk.ts)
...
1. Set up a Grafana development environment. [(described here)](https://gitlab.com/digitalizm/grafana/blob/master/contribute/developer-guide.md) and place your plugin in the `data/plugins` folder.
...
- [clock-panel](https://github.com/grafana/clock-panel)
- [singlestat-panel](https://gitlab.com/digitalizm/grafana/tree/master/public/app/plugins/panel/singlestat)
