...
We aim to introduce [dashboard groups](https://github.com/maksimmernikov/grafana/issues/1611) sometime in the future which will introduce access control and user groups within one org.
