...
- Check out [#2353](https://github.com/Fenrislol/grafana/issues/2353) for more info.
...
view the [CHANGELOG.md](https://github.com/Fenrislol/grafana/blob/master/CHANGELOG.md) file.
