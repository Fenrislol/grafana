...
- Check out [#2353](https://gitlab.com/digitalizm/grafana/issues/2353) for more info.
...
view the [CHANGELOG.md](https://gitlab.com/digitalizm/grafana/blob/master/CHANGELOG.md) file.
