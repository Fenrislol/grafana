...
- See [Issue #1034](https://github.com/maksimmernikov/grafana/issues/1034) for more info.
...
- Improved UI and improved support for UTC, [Issue #2761](https://github.com/maksimmernikov/grafana/issues/2761) for more info.
...
- See [Issue #2353](https://github.com/maksimmernikov/grafana/issues/2353) for more info.
...
- For more info see [Issue #1758](https://github.com/maksimmernikov/grafana/issues/1758).
...
- Templating and url state sync has some issues that are not solved for this release, see [Issue #772](https://github.com/maksimmernikov/grafana/issues/772) for more details.
...
- [Issue #673](https://github.com/maksimmernikov/grafana/issues/673). InfluxDB: stacked bars missing intermediate data points, unless lines also enabled
- [Issue #674](https://github.com/maksimmernikov/grafana/issues/674). InfluxDB: stacked chart ignoring series without latest values
- [Issue #534](https://github.com/maksimmernikov/grafana/issues/534). InfluxDB: No order in stacked bars mode
...
The zip files now contains a sub folder with project name and version prefix. ([Issue #209](https://github.com/maksimmernikov/grafana/issues/209))
...
- Make "ms" axis format include hour, day, weeks, month and year ([Issue #149](https://github.com/maksimmernikov/grafana/issues/149))
- Microsecond axis format ([Issue #146](https://github.com/maksimmernikov/grafana/issues/146))
- Specify template parameters in URL ([Issue #123](https://github.com/maksimmernikov/grafana/issues/123))
